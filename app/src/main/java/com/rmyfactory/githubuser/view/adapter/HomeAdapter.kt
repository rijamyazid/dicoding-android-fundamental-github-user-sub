package com.rmyfactory.githubuser.view.adapter
...
import com.rmyfactory.githubuser.databinding.ItemHolderUserBinding
...
class HomeAdapter(
    ...
    class UserViewHolder(private val binding: ItemHolderUserBinding) :
